            ...
            <div class="col-md-12">
                ...
                <div class="portlet light bordered">
                    <div class="portlet-title">
                        <div class="caption font-dark">
                            ...
                            <span class="caption-subject bold uppercase"><?php echo $judul ?>
                                        <a class="btn btn-primary btn-sm" href="<?php echo site_url('nasabah/create') ?>"><i class="fa fa-plus"></i> Tambah </a>
                            </span>
                        </div>
                        <div class="tools">
                        </div>
                    ...
                    <div class="portlet-body">
                        <table class="table table-striped table-hover table-checkable dt-responsive" width="100%" id="tabel_nasabah">
                            <thead>
                                <tr>
                                    <th>No</th>
                                    <th>Nik</th>
...
tabel_nasabah = $('#tabel_nasabah').DataTable({
    buttons: [
    ...
    "ajax": {
        "url": "<?php echo site_url('nasabah/list')?>",
        "type": "POST",
        data: function (d) {
        }
    },
