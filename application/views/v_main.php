...
<html>
  <head>
    ...
    <!-- Font Awesome -->
    <link rel="stylesheet" href="<?= base_url();?>assets/Font_Awesome/css/font-awesome.min.css">
    <!-- Ionicons -->
      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview <?= ($menu_parent=='office') ? 'active' : '';?>">
              <a href="#">
              ...
              <ul class="treeview-menu">
                ...
                <li class="<?= ($menu_child=='office') ? 'active' : '';?>"><a href="data.html"><i class="fa fa-circle-o"></i> Data tables</a></li>
              </ul>
            </li>
            <li>
